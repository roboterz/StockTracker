...
import com.aerolite.stocktracker.data.StockHolding
import com.aerolite.stocktracker.databinding.*
import com.aerolite.stocktracker.ui.components.ChartSegment
import com.aerolite.stocktracker.ui.components.LineData
import com.aerolite.stocktracker.ui.components.formatCurrency
import com.aerolite.stocktracker.ui.screens.AssetType
import com.aerolite.stocktracker.ui.screens.PortfolioListItem
import com.aerolite.stocktracker.ui.viewmodel.StockUiState
import com.aerolite.stocktracker.ui.viewmodel.TimeRange
...
class PortfolioAdapter(
    ...
    class CashTransactionViewHolder(private val binding: ListItemCashTransactionBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        fun bind(transaction: com.aerolite.stocktracker.data.CashTransaction, onCashItemClicked: (CashTransaction) -> Unit) {
